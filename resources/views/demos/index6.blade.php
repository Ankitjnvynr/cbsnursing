...
@section('content')
    ...
    <header class="main-header-six">
                                ...
                                <ul class="main-menu__list">
                                    ...
                                    <li class="dropdown">
                                        ...
                                        <ul>
                                            ...
                                            <li><a href="{{ route('carInsurance') }}">Car insurance</a></li>
                                            <li><a href="{{ route('lifeInsurance') }}">Life insurance</a></li>
                                            <li><a href="{{ route('homeInsurance') }}">Home insurance</a>
                                            </li>
                                            <li><a href="{{ route('healthInsurance') }}">Health insurance</a></li>
                                            <li><a href="{{ route('businessInsurance') }}">Business insurance</a></li>
                                            <li><a href="{{ route('fireInsurance') }}">Fire insurance</a></li>
                                            <li><a href="{{ route('marriageInsurance') }}">Marriage insurance</a></li>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="100ms">
                        <div class="feature-six__single">
                            <div class="feature-six__single-inner">
                                ...
                                <h3 class="feature-six__title"><a href="{{ route('about') }}">Safe Your Money</a></h3>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="200ms">
                        <div class="feature-six__single">
                            <div class="feature-six__single-inner">
                                ...
                                <h3 class="feature-six__title"><a href="{{ route('contact') }}">Get a free quote</a></h3>
                                <p class="feature-six__text">Duis aute irure dolor reprehenderit voluptate
                                    velit esse cillum dolore eu fugiat nulla pariatur.
                                    Excepteur sint occaecat</p>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4 wow fadeInUp" data-wow-delay="300ms">
                        <div class="feature-six__single">
                            <div class="feature-six__single-inner">
                                ...
                                <h3 class="feature-six__title"><a href="{{ route('about') }}">Fast & reliable</a></h3>
                                <p class="feature-six__text">Duis aute irure dolor reprehenderit voluptate
                                    velit esse cillum dolore eu fugiat nulla pariatur.
                                    Excepteur sint occaecat</p>
                            </div>
                    ...
                    <div class="services-six__carousel owl-carousel owl-theme thm-owl__carousel" data-owl-options='{
                        ...
                        <div class="item">
                            <div class="services-six__single">
                                ...
                                <h3 class="services-six__title"><a href="{{ route('carInsurance') }}">car insurance</a></h3>
                        ...
                        <div class="item">
                            <div class="services-six__single">
                                ...
                                <h3 class="services-six__title"><a href="{{ route('lifeInsurance') }}">life insurance</a></h3>
                                <p class="services-six__text">Lorem ipsum dolor amet, consectetur
                                    adipiscing elit, sed eiusmod tempor
                                    incididunt labore..</p>
                                <div class="services-six__btn-box">
                        ...
                        <div class="item">
                            <div class="services-six__single">
                                ...
                                <h3 class="services-six__title"><a href="{{ route('homeInsurance') }}">Home Insurance</a></h3>
                                <p class="services-six__text">Lorem ipsum dolor amet, consectetur
                                    adipiscing elit, sed eiusmod tempor
                                    incididunt labore..</p>
                                <div class="services-six__btn-box">
                        ...
                        <div class="item">
                            <div class="services-six__single">
                                ...
                                <h3 class="services-six__title"><a href="{{ route('healthInsurance') }}">Health Insurance</a>
                                </h3>
                                <p class="services-six__text">Lorem ipsum dolor amet, consectetur
                                    adipiscing elit, sed eiusmod tempor
                                    incididunt labore..</p>
        ...
        <section class="get-insuracne-three">
